...
var firebaseConfig = {
    apiKey: "AIzaSyDSBHJR-HZ9R467AY4eW00BcS9CKEo4Ha4",
    authDomain: "pebble-6a339.firebaseapp.com",
    projectId: "pebble-6a339",
    storageBucket: "pebble-6a339.appspot.com",
    messagingSenderId: "1075221716257",
    appId: "1:1075221716257:web:54d4639b639debd5e0b260",
    measurementId: "G-5C265612GT"
};
// Initialize Firebase
...
export default {
    setup() {
        ...
        const f7params = {
            name: 'Pebble', // App name
            theme: 'auto', // Automatic theme detection

            id: 'io.framework7.pebble', // App bundle ID
            // App store
            store: store,
            // App routes
            routes: routes,
